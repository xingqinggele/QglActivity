 ...
 * 描述:
 */
public class BusinessNewsAdapter extends BaseQuickAdapter<BusinessMessageBean, BaseViewHolder> {

    public BusinessNewsAdapter(int layoutResId, @Nullable List<BusinessMessageBean> data) {
