 ...
 * 描述:邀请伙伴
 */
public class InvitePartnersModel implements IInvitePartnersModel{

    @Override
    public void inviteData(OnLoadListener loadListener) {
        ...
        HttpRequest.getInvitationPartner(params, new ResponseCallback() {
            ...
            public void onSuccess(Object responseObj) {
                ...
                try {
                    ...
                    InvitePartnersBean data = gson.fromJson(object.toString(), InvitePartnersBean.class);
