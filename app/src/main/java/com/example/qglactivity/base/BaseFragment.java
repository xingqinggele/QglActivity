package com.example.qglactivity.base;
...
import com.example.qglactivity.activity.LoginActivity;
import com.example.qglactivity.presenter.BasePresenter;
import com.example.qglactivity.util.SPUtils;
import com.example.qglactivity.view.IBaseView;
...
public abstract class BaseFragment<T extends BasePresenter,V extends IBaseView>extends Fragment implements SwipeRefreshLayout.OnRefreshListener {
   protected T presenter;
    ...
    public void SwipeData(SwipeRefreshLayout swipeRefreshLayout){
        swipeRefreshLayout.setColorSchemeResources(R.color.new_theme_color, R.color.green, R.color.colorAccent);
